...
if [[ "$architecture" == "arm64" ]]; then
  url="https://github.com/Phantom8015/Tritium/releases/download/v2.4.1/Tritium-2.4.1-arm64-mac.zip"
elif [[ "$architecture" == "x86_64" ]]; then
  url="https://github.com/Phantom8015/Tritium/releases/download/v2.4.1/Tritium-2.4.1-mac.zip"
else
